...
const guides: Guide[] = [
  {
    slug: "four-rivers",
    title: "La ruta 4 Rivers (Four Rivers) de Corea, explicada",
    description: "Qué cubre realmente la certificación Four Rivers de Corea, cómo se solapa con la ruta Incheon–Busan y el menú completo de vías certificables más allá de los ríos.",
    lastVerified: "2026-07-21",
    sections: [
      { heading: "Qué es realmente la Four Rivers", paragraphs: ["La certificación Four Rivers (4대강 종주) cubre las vías ciclistas de los cuatro grandes ríos de Corea: el Han, el Nakdong, el Geum y el Yeongsan. Importante: NO es una ruta continua. Son cuatro vías separadas, unos 860 km en total, y dos de ellas quedan en el suroeste, lejos de las otras dos. Se completa pedaleando cada una y sellando en el mismo Bike Passport."] },
      { heading: "Su relación con la ruta transnacional", paragraphs: ["Piensa en las certificaciones como conjuntos que se solapan. La ruta Incheon→Busan ya contiene los tramos completos del Han y del Nakdong — así que el día que terminas en Busan llevas dos de los cuatro ríos hechos, lo pretendieras o no. Añade después el Geum y el Yeongsan y la medalla Four Rivers cae con el mismo pasaporte. (Por eso confunde tanto el cartel de 'Four Rivers' en la meta de Busan: marca un punto final compartido, no una certificación completada.)"] },
      { heading: "Los dos ríos que te faltan", list: [
        "Vía del Geumgang (금강, ~146 km): presa de Daecheong → dique del estuario del Geum, pasando por Sejong, Gongju y Buyeo — el corazón del antiguo reino de Baekje. Llana, tranquila, entre templos y fortalezas.",
        "Vía del Yeongsangang (영산강, ~133 km): presa de Damyang → estuario cerca de Mokpo, por el bosque de bambú y la avenida de metasecuoyas de Damyang y la ciudad de Gwangju. La más amable de las cuatro.",
        "Cada una es un cómodo viaje de 2 días, o un combinado suroeste de 4–5 días — tren y bus llegan bien a ambos extremos.",
      ] },
      { heading: "Más allá de los ríos: el menú completo", paragraphs: ["El mismo pasaporte cubre una red nacional de vías certificables — la transnacional y la Four Rivers son solo las cabezas de cartel:"], list: [
        "Bukhangang (북한강, ~70 km) — ramal al noreste de Seúl, escapada perfecta de fin de semana.",
        "Ocheon (오천, ~105 km) — los «cinco arroyos» que enlazan la zona de Saejae con el río Geum.",
        "Seomjingang (섬진강, ~149 km) — para muchos la vía fluvial más bonita, con cerezos en primavera.",
        "Costa este: Gangwon (~242 km) y Gyeongbuk (~122 km) — playas y puertos pesqueros del mar del Este, con final norte en el observatorio de la DMZ.",
        "Jeju Fantasy (제주환상, ~234 km) — la vuelta a la isla de Jeju; en sentido antihorario por los vientos.",
        "Reúne todos los centros de certificación del país y ganas la medalla Grand Slam: el jefe final del sistema. Nota honesta para visitantes: son miles de kilómetros por cada rincón del país, fuera del alcance realista de una estancia turística normal. Tómalo como una razón para volver, no como meta de un solo viaje.",
      ] },
      { heading: "Estrategia práctica — elige según tu estancia", list: [
        "Mismo pasaporte, mismas casetas rojas, mismas reglas en todas partes: un pasaporte de ₩4.000 vale para todas las vías y medallas.",
        "Viaje estándar (1–2 semanas): primero la transnacional (el buque insignia); vuelve otro año a por Geum + Yeongsan para reclamar la 4 Rivers.",
        "¿Poco tiempo (3–4 días)? Sáltate la península y pedalea el circuito Jeju Fantasy: una certificación completa y autocontenida, con paisaje isleño y arrancando junto al aeropuerto.",
        "¿Tienes más tiempo? Encadena desde Busan: la ruta de la costa este sale con naturalidad de la meta transnacional y sube por Gyeongbuk y Gangwon hasta el observatorio de la DMZ — Busan es la base perfecta para seguir sumando tramos jongju.",
        "Las medallas se acumulan: transnacional, 4 Rivers y Grand Slam son distintas — los completistas pueden ganar las tres, aunque rara vez en una sola visita.",
      ] },
    ],
  },
  {
  ...
  {
    slug: "food",
    title: "La lista gastronómica coreana del ciclista",
    ...
    sections: [
      ...
      { heading: "La lista", list: [
        ...
        "Samgyeopsal (삼겹살) — panceta que asas tú mismo. Ceremonia de la primera noche; combina criminalmente bien con 100 km en las piernas.",
        "Chimaek (치맥) — pollo frito + cerveza, idealmente a domicilio en un parque junto al río. El protocolo nacional coreano de recuperación.",
        "Ramyeon de tienda 24h (라면) — el ritual: máquina de agua caliente, banco de plástico, vistas al río. Sabe mejor que cualquier versión de restaurante, nadie sabe por qué.",
      ...
      { heading: "Notas dietéticas, en breve", list: [
        "Vegetariano es viable con esfuerzo — bibimbap (비빔밥, pide «gogi ppae-juseyo» = sin carne), variantes de kimbap y las tiendas 24h son tus aliados. El veganismo estricto es realmente difícil en el campo.",
        "¿Alergias serias? Lleva una tarjeta traducida en el móvil; los caldos suelen ser de ternera, cerdo o anchoa.",
      ] },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Palabras de agua (te acompañan 600 km)", list: [
        "`강` `gang` — río. Han**gang** (한강) = río Han; Nakdong**gang** (낙동강) = río Nakdong. La ruta son básicamente cuatro de estos.",
        "`천` `cheon` — arroyo. La vía O**cheon** (오천) = «cinco arroyos».",
        "`호` `ho` — lago. Chungju**ho** (충주호).",
        "`보` `bo` — presa/azud. Ipo**bo** (이포보), Gangjeong-Goryeong**bo** (강정고령보): los grandes azudes donde se agrupan casetas y centros atendidos.",
        "`댐` `daem` — presa grande. Chungju**daem** (충주댐), Andong**daem** (안동댐): extremos de vías fuera de la línea transnacional.",
        "`하굿둑` `hagutduk` — dique de estuario. El Nakdong**gang** Hagutduk es la meta en Busan.",
        "`갑문` `gapmun` — esclusa. Ara West Sea Lock (아라서해갑문): donde empieza el viaje de tu pasaporte.",
        "`나루` `naru` — antiguo embarcadero. Gwang**naru** (광나루) en Seúl conserva el nombre.",
      ] },
      { heading: "Palabras de terreno (las que duelen)", list: [
        "`령` `ryeong` — puerto de montaña (sino-coreano). Ihwa**ryeong** (이화령): la única subida seria. ¿Ves esta terminación? Come primero.",
        "`재` `jae` — puerto (coreano nativo, mismo aviso). La vía Sae**jae** (새재) debe su nombre al paso histórico de Mungyeong.",
      ...
      { heading: "Lee una señal de verdad", paragraphs: ["Descompón un par de señales reales y el truco se hace evidente:"], list: [
        "`이화령휴게소 인증센터` = Ihwa-**ryeong** (puerto) + hyugeso (área de descanso) + centro de certificación → «caseta de sellos en lo alto del Ihwa**ryeong**».",
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Si algo sale mal", list: [
        ...
        "Guarda los tres antes de empezar a pedalear. Lo más probable es que no marques ninguno — y esa es precisamente la gracia de pedalear en Corea.",
      ] },
    ],
  },
  {
